          ...
          <span class="align-middle">AdminKit</span>
              ...
              <i class="align-middle" data-feather="log-in"></i> <span class="align-middle">Products</span>
					...
					<li class="sidebar-item {{Request::is('admin/attributes') ? 'active':''}}">
						<a class="sidebar-link" href="{{ url('admin/attributes') }}">
              <i class="align-middle" data-feather="user-plus"></i> <span class="align-middle">Attributes</span>
            </a>
					</li>

					<li class="sidebar-item {{Request::is('admin/coupons') ? 'active':''}}">
						<a class="sidebar-link" href="{{url('admin/coupons')}}">
              <i class="align-middle" data-feather="book"></i> <span class="align-middle">Coupons</span>
            </a>
					</li>
